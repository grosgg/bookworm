...
export default function BookSearchForm() {
  ...
  const [scannerButtonDisplay, setScannerButtonDisplay] = useState<boolean>(() => searchParams.get('searchType') === 'isbn');
  const [scannerDisplay, setScannerDisplay] = useState<boolean>(false);

  const setSearchUrl = ({ searchType, query, lang }: { searchType: 'title' | 'isbn'; query: string; lang: 'en' | 'fr' | 'ja' }) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setSearchUrl({ searchType, query, lang });
  };
